...
// Endereço da API. O backend serve o frontend a partir da mesma origem
// (backend/public/), então basta um caminho relativo — funciona tanto
// local (npm start) quanto em produção (Render).
